...
const Footer = () => {
    ...
    return (
        <footer id='footer' className='text-white pt-4 pl-24' style={{ backgroundColor: '#123F1E' }}>
                ...
                <div className='grid md:grid-cols-4 lg:grid-cols-5 sm:grid-cols-4 grid-cols-2 sm:gap-x-2 lg:gap-x-0 gap-x-1.5 sm:gap-y-9 lg:gap-y-0 gap-y-7 '>
                    ...
                    {/* About Grocery */}
                    <div className='col sm:col-span-2  lg:col-span-2 xl:space-y-6 space-y-4 mt-3'>
                        {/* Brand_Logo */}
